					...
					?>
								<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
									...
									<td class="cart-product-info" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
												...
												<div class="pcat-result-item-footer-product-price price" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
													<?php
														...
														*/
														...
														//echo $_product->get_price_html(); //commented out on 16/12/2022 to fix issue with woo discount rules calculating discount from sale price
										...
										<div class="cart-product-favorite-btnx">
											<?php echo do_shortcode('[yith_wcwl_add_to_wishlist product_id="' . $_product->get_id() . '"]'); ?>
											<!--br/><span><?php include get_template_directory() . '/assets/icons/favorite-black-icon.svg'; ?></span>μετακίνηση στα αγαπήμενα -->
										</div>
