<?php if( get_field('homepage_publisher_suggestions_rel') ) { ?>
<section class="book-slider book-suggestion book-slider--border-bottom" is="mieteshop-book-slider">
    <div class="book-slider-container">
        <div class="book-slider-title">
            <h2><?php if(get_field('homepage_publisher_suggestions_title')) { echo get_field('homepage_publisher_suggestions_title'); } ?></h2>
            <!--p></p-->
        </div>
