<?php if( get_field('homepage_rare_editions_miet_rel') ) { ?>
<section class="book-slider book-rare-editions-miet book-slider--border-bottom" is="mieteshop-book-slider">
    <div class="book-slider-container">
        <div class="book-slider-title">
            <h2>ΣΠΑΝΙΕΣ ΕΚΔΟΣΕΙΣ ΜΙΕΤ</h2>
        </div>
        <div class="book-slider-wrapper">
            <div class="swiper-container" data-slider>
                <div class="swiper-wrapper">
                    <?php
                        $homepage_rare_editions_miet_rel = get_field('homepage_rare_editions_miet_rel');

                        foreach($homepage_rare_editions_miet_rel as $edition){
