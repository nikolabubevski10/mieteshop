<?php if( get_field('homepage_rare_editions_rel') ) { ?>
<section class="book-slider book-rare-editions book-slider--border-bottom" is="mieteshop-book-slider">
    <div class="book-slider-container">
        <div class="book-slider-title">
            <h2>ΣΠΑΝΙΕΣ ΕΚΔΟΣΕΙΣ ΑΛΛΩΝ ΦΟΡΕΩΝ</h2>
        </div>
