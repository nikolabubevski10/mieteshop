<?php if( get_field('homepage_thematic_suggestions_rel') ) { ?>
<section class="book-slider" is="mieteshop-book-slider">
    <div class="book-slider-container">
        <div class="book-slider-title">
            <h2><?php if(get_field('homepage_thematic_suggestions_title')) { echo get_field('homepage_thematic_suggestions_title'); } ?></h2>
            <!--p></p-->
        </div>
