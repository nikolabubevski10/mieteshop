<?php
add_action('wp_ajax_filter_best_sellers_product', 'filterBestSellersProduct');
add_action('wp_ajax_nopriv_filter_best_sellers_product', 'filterBestSellersProduct');

function filterBestSellersProduct()
{
    if (!wp_verify_nonce($_REQUEST['nonce'], 'filter_best_sellers_product_nonce')) {
    ...
    $pagination->css_classes([
        ...
        'list_item' => 'js-best-sellers-results-navigation-item pcat-results-navigation-item',
        'prev' => 'js-best-sellers-results-navigation-item pcat-results-navigation-prev',
        'next' => 'js-best-sellers-results-navigation-item pcat-results-navigation-next',
        'anchor' => '',
    ]);
